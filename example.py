...
# ------------->>>>>>>>>
        ...
        ## Note differrences ##
'''
Have a lower accuracy and less detailed word representations.(Don't ship with word vectors)

Produced slightly different similarity scores compared due to its limited vocabulary and word representations.

Have lower computational requirements and faster execution time because of its smaller size.

By comparing the output and similarity scores obtained to the previous results, and
you can observe differences in the quality of the semantic similarity predictions, and
